...
- **Somnia** — Dream Journal & Interpreter
- **Matria** — Pregnancy Tracker
- **Rootine** — Plant Care Companion
- **Radar Flow** — Radar Detection
- **Growlytics AI** — Growth Intelligence Platform (co-built with Alperen Şirin)
